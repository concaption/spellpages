  ...
  return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
      ...
      <nav className="mb-8 text-xs font-mono text-muted-foreground">
        ...
        <span className="mx-1.5 opacity-40">/</span>
        <span className="text-foreground">{book.slug}</span>
      </nav>

      {/* Book Header */}
      <div className="flex flex-col md:flex-row gap-8 mb-12">
        <div className="w-full md:w-64 shrink-0">
          <div className="relative aspect-[2/3] sketch-border overflow-hidden">
            <Image
              src={book.coverImage}
              alt={book.title}
              fill
        ...
        <div className="flex-1">
          ...
          <div className="mt-6">
            <a
              ...
              className="inline-flex items-center gap-2 sketch-border bg-primary px-5 py-2.5 text-sm font-medium text-primary-foreground hover:opacity-90 transition-opacity"
            >
        ...
        <div className="grid gap-2">
          {book.skills.map((skill, index) => (
            <Link
              ...
              className="flex items-center gap-4 sketch-border p-4 hover:bg-muted/50 transition-colors group"
            >
              <span className="flex h-8 w-8 shrink-0 items-center justify-center sketch-border text-xs font-mono font-bold text-muted-foreground">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="text-muted-foreground shrink-0 opacity-40">
